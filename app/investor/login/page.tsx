    ...
    <div className="page-shell min-h-screen flex items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-700/60 bg-slate-900/90 p-8">
          <h1 className="text-xl font-bold text-white mb-2">Investor Sign In</h1>
          <p className="text-sm text-slate-400 mb-6">
            Access your account to browse and unlock motivated seller leads.
          </p>
          ...
          <p className="mt-6 text-center text-sm text-slate-400">
            Need an account?{" "}
            <Link href="/investor/signup" className="text-amber-400 hover:text-amber-300">
              Create one free
            </Link>
          </p>
        </div>
