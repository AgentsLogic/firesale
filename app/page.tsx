...
export default function Home() {
  ...
  return (
    <div className="page-shell min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-24 pt-12 md:pt-16">
        ...
        >
          <div className="fs-animate-hero">
            <p className="mb-3 inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-amber-400/5 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.16em] text-amber-300">
            ...
            <div className="mt-6 flex flex-col gap-3 text-xs text-slate-300 sm:flex-row sm:items-center">
              <a
                href="#get-offers"
                className="inline-flex items-center justify-center rounded-full bg-amber-400 px-5 py-2 text-xs font-semibold text-slate-950 shadow-sm shadow-amber-400/40 transition hover:bg-amber-300"
              >
            ...
            <dl className="mt-8 grid max-w-xl grid-cols-2 gap-4 text-xs text-slate-300 md:text-sm">
              <div>
                <dt className="text-slate-400">Typical offer window</dt>
                <dd className="font-semibold text-slate-50">24–72 hours*</dd>
              </div>
              <div>
                <dt className="text-slate-400">Condition</dt>
                <dd className="font-semibold text-slate-50">As‑is, no repairs required</dd>
              </div>
              <div>
                <dt className="text-slate-400">Seller fee to FireSaleHomes</dt>
                <dd className="font-semibold text-emerald-300">$0 – buyer pays our fee</dd>
              </div>
              <div>
                <dt className="text-slate-400">Coverage</dt>
                <dd className="font-semibold text-slate-50">Select U.S. metros (expanding)</dd>
              </div>
            </dl>
          </div>
        ...
        {/* How it works */}
        <section id="how-it-works" className="mt-16 fs-animate-section border-t border-slate-800/80 pt-10">
          ...
          <ol className="mt-6 grid gap-6 text-xs text-slate-200 md:grid-cols-3 md:text-sm">
            <li className="fs-animate-card-1 rounded-2xl border border-slate-800 bg-slate-950/40 p-4">
              <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-400">Step 1</div>
              <h3 className="mt-2 text-sm font-semibold text-slate-50">Tell us about the property</h3>
              <p className="mt-2 text-xs text-slate-300">
                Share the basics—address, condition, and timeline. We use this to decide which buyers are a fit.
              </p>
            </li>
            <li className="fs-animate-card-2 rounded-2xl border border-slate-800 bg-slate-950/40 p-4">
              <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-400">Step 2</div>
              <h3 className="mt-2 text-sm font-semibold text-slate-50">We invite pre‑vetted buyers</h3>
              <p className="mt-2 text-xs text-slate-300">
                Verified investors review your property details and submit as‑is offers—often within 24–72 hours.*
              </p>
            </li>
            <li className="fs-animate-card-3 rounded-2xl border border-slate-800 bg-slate-950/40 p-4">
              <div className="text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-400">Step 3</div>
              <h3 className="mt-2 text-sm font-semibold text-slate-50">You choose what happens next</h3>
              <p className="mt-2 text-xs text-slate-300">
        ...
        {/* Investor section */}
        <section id="investors" className="mt-16 fs-animate-section rounded-3xl border border-slate-800/80 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 p-6">
          <div className="grid gap-8 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] md:items-center">
            <div className="fs-animate-hero">
              ...
              <h2 className="mt-2 text-balance text-lg font-semibold text-slate-50 md:text-xl">
              ...
              <ul className="mt-4 grid gap-2 text-xs text-slate-200 md:text-sm">
            ...
            <div className="fs-animate-hero-secondary rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
              <h3 className="text-sm font-semibold text-slate-50">Join the investor waitlist</h3>
              <p className="mt-1 text-[11px] text-slate-400">
              ...
              >
                ...
                <div>
                  <label className="block text-[11px] font-medium text-slate-300" htmlFor="investorName">
                    Name & company
                  </label>
                  <input
                    id="investorName"
                ...
                <div>
                  <label className="block text-[11px] font-medium text-slate-300" htmlFor="investorEmail">
                    Email
                  </label>
                  <input
                    id="investorEmail"
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div>
                    <label className="block text-[11px] font-medium text-slate-300" htmlFor="metros">
                      Target metros
                    </label>
                    <input
                      id="metros"
                  ...
                  <div>
                    <label className="block text-[11px] font-medium text-slate-300" htmlFor="buyBox">
                      Buy box
                    </label>
                    <input
                      id="buyBox"
                ...
                <button
                  ...
                  className="mt-1 inline-flex w-full items-center justify-center rounded-full bg-slate-50 px-4 py-2 text-xs font-semibold text-slate-950 shadow-sm shadow-slate-50/20 transition hover:bg-amber-200 hover:text-slate-950 disabled:cursor-not-allowed disabled:opacity-60"
                >
      ...
      <footer className="border-t border-slate-900/80 bg-slate-950/90 py-6">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-3 px-6 text-[11px] text-slate-500 sm:flex-row sm:items-center">
          <p>
