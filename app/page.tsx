        ...
        >
          <div className="fs-animate-hero">
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-slate-200 md:text-base">
              ...
              One simple form, multiple competing offers, no showings, as-is, no pressure.
            </p>
            ...
            <dl className="mt-8 grid max-w-xl grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <dd className="font-semibold text-white">Major metros (expanding)</dd>
              </div>
            </dl>
          </div>
          ...
          <div className="grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] md:items-center">
            ...
            <div className="fs-animate-hero-secondary rounded-2xl border border-slate-700/60 bg-slate-900/90 p-6 shadow-xl">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Create your free investor account to browse motivated seller leads.
              </p>
              <a
                href="/listings"
          ...
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
            <div className="flex items-center gap-6 text-xs">
              ...
              <nav className="flex gap-4">
                <Link href="/terms" className="text-slate-400 hover:text-amber-400 transition">Terms of Service</Link>
                <Link href="/privacy" className="text-slate-400 hover:text-amber-400 transition">Privacy Policy</Link>
              </nav>
            </div>
